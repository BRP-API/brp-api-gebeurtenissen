...
graph LR
  ...
  subgraph diagram ["BRP Gebeurtenissen en Notificaties - System Context"]
    ...
    2("<div style='font-weight: bold'>BRP Gebeurtenissen en Notificaties</div><div style='font-size: 70%; margin-top: 0px'>[Software System]</div><div style='font-size: 80%; margin-top:10px'>Vertalen van data mutaties in<br />de BRP naar gebeurtenissen en<br />afnemers notificeren over<br />deze gebeurtenissen</div>")
    style 2 fill:#dddddd,stroke:#0773af,color:#0773af

    11-. "<div>abonneert op gebeurtenissen<br />met</div><div style='font-size: 70%'></div>" .->2
    2-. "<div>muteert gegevens van personen<br />in test</div><div style='font-size: 70%'></div>" .->1
