...
## Sequence diagram: gebeurtenissen bevragen door afnemer
```mermaid
sequenceDiagram
    participant Afnemer
    box Grey BRP Gebeurtenissen
    ...
    Afnemer->>EvtApi: vraagt gebeurtenissen
    EvtApi->>ES: bevraagt gebeurtenissen<br/> voor afnemer adhv zijn abonnement
