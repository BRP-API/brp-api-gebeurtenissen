export class Adres {
  ...
  constructor(gemeente_code?: string, verblijf_plaats_ident_code?: string, adres_functie?: string) {
  ...
  getPropertyNames(): string[] {
    return ['adres_id', 'gemeente_code', 'verblijf_plaats_ident_code', 'adres_functie'];
  }
}
