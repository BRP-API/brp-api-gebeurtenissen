...
Functionaliteit: Gebeurtenissen bevragen
  ...
  Achtergrond:
    ...
    En een gebeurtenis heeft de volgende gegevens
      | specversion | type                         | id    | time                    |
      |         1.0 | nl.brp.EersteInschrijvingBRP | A1234 | vandaag 2 dagen geleden |
    En de gebeurtenis heeft de volgende 'data' gegevens
      | burgerservicenummer | gemeenteVanInschrijving.code |
      |           123456789 | G1                           |
    En de gebeurtenis is gepubliceerd
    En een andere gebeurtenis heeft de volgende gegevens
      | specversion | type                         | id    | time                  |
      |         1.0 | nl.brp.EersteInschrijvingBRP | A2345 | vandaag 1 dag geleden |
    En de gebeurtenis heeft de volgende 'data' gegevens
      | burgerservicenummer | gemeenteVanInschrijving.code |
      |           234567890 | G1                           |
    En de gebeurtenis is gepubliceerd
  ...
  Regel: Een gebeurtenis kan worden bevraagd met zijn identifier als de bevrager zich op de gebeurtenis heeft geabonneerd
    ...
    Scenario: Afnemer is geabonneerd op 'EersteInschrijvingBRP' gebeurtenissen in gemeente 'G1'
    ...
    Scenario: Afnemer is niet geabonneerd op 'EersteInschrijvingBRP' gebeurtenissen
  ...
  Regel: Een afnemer kan gebeurtenissen vanaf een datum als niet-gelezen markeren
    ...
    Scenario: Afnemer heeft alle niet-gelezen gebeurtenissen gevraagd en markeert gebeurtenissen vanaf een datum als niet-gelezen
      ...
      Dan wordt de gebeurtenis met de volgende gegevens geleverd
        | specversion | type                         | id    | time                    |
        |         1.0 | nl.brp.EersteInschrijvingBRP | A2345 | vandaag 1 dagen geleden |
      En heeft de gebeurtenis de volgende 'data' gegevens
        | burgerservicenummer | gemeenteVanInschrijving.code |
        |           234567890 | G1                           |
