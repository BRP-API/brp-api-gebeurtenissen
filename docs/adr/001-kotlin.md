...
De keuze voor de programmeertaal staat open voor BRP API Gebeurtenissen. Java is de dominante taal binnen RvIG. Een deel van het team programmeert in C# terwijl een ander deel programmeert in Java. 
...
8. **developer productivity**: samenvattend maakt Kotlin het mogelijk om kortere, expressievere en veiligere code te schrijven, wat bijdraagt aan de productiviteit van ontwikkelaars en de doelen van RvIG.
